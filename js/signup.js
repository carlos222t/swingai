(function(){
  ...
  document.getElementById("signupForm").addEventListener("submit", async e => {
    ...
    // Held in sessionStorage (not just a JS variable) so it survives the
    // navigation to verify.html — losing it on navigate/reload was the
    // likely cause of "incorrect code" reports (verify.html was still
    // holding an unrelated token, or none at all).
